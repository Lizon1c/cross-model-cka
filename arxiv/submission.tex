...
\author{[First Author]\thanks{Corresponding author: email@example.com} \\
  \textit{Affiliation} \\
  \and
  [Second Author / Advisor] \\
  \textit{Affiliation}
}
...
(194,560--802,560 pairs). The strongest raw head pair achieves CKA~=~0.851 
(2,000-permutation max-null $p \approx 0.0005$). 
